...
Tools:
    ...
    5. get_fault_report — active faults + severity
...
async def list_tools():
    return [
        ...
        Tool(
            name="get_fault_report",
            description="Returns active fault codes with severity and vehicle info. "
...
async def call_tool(name: str, arguments: dict):
    try:
        ...
        elif name == "get_fault_report":
            return await _get_fault_report()
...
async def _get_fault_report():
    faults = geotab.get_active_faults()
    return [TextContent(type="text", text=json.dumps({
